...
def train(args):
    ...
    t_loader = data_loader(data_path, is_transform=True, img_size=(args.img_rows, args.img_cols), augmentations=False)
    ...
    valloader = data.DataLoader(v_loader, batch_size=args.batch_size, num_workers=6)
