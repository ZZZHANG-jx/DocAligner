...
import time
import os 
from models.deep_lab_model.deeplab import *
...
if __name__ == '__main__':
    ...
    parser.add_argument('--im_folder', nargs='?', type=str, default='./all_data',help='Data path to load data')
    ...
    im_paths = glob.glob(os.path.join(args.im_folder,'*_origin.*'))
