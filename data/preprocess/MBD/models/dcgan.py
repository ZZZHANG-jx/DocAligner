'''
copy from https://github.com/martinarjovsky/WassersteinGAN/blob/f7a01e82007ea408647c451b9e1c8f1932a3db67/models/dcgan.py#L5
'''
...
class Discriminator(torch.nn.Module):
    def __init__(self, channels):
        ...
        self.output = nn.Sequential(
            nn.Conv2d(in_channels=1024, out_channels=512, kernel_size=4, stride=1, padding=0),
