...
from models.gienet import *
from models.network import ResnetDilatedRgressAndClassifyV2v6v4c1GNomsk
...
def _get_model_instance(name):
    try:
        return {
            ...
            'bmp':BmpGenerator,
            'displacement':ResnetDilatedRgressAndClassifyV2v6v4c1GNomsk
        }[name]
    except:
