...
class DilatedResnetForFlatByClassifyWithRgressV2v6v4c1GNomsk(nn.Module):

	def __init__(self, n_classes, num_filter, BatchNorm, in_channels=3):
		super(DilatedResnetForFlatByClassifyWithRgressV2v6v4c1GNomsk, self).__init__()
		self.in_channels = in_channels
		self.n_classes = n_classes
		self.num_filter = num_filter
		# act_fn = nn.PReLU()
		...
		is_dropout = False
		print("\n------load DilatedResnetForFlatByClassifyWithRgressV2v6v4c1GNomsk------\n")
...
class ResnetDilatedRgressAndClassifyV2v6v4c1GNomsk(nn.Module):
	def __init__(self, n_classes, num_filter, BatchNorm='GN', in_channels=3):
		super(ResnetDilatedRgressAndClassifyV2v6v4c1GNomsk, self).__init__()
		self.in_channels = in_channels
		self.n_classes = n_classes
		self.num_filter = num_filter
		BatchNorm = nn.GroupNorm
		...
		self.dilated_unet = DilatedResnetForFlatByClassifyWithRgressV2v6v4c1GNomsk(self.n_classes, self.num_filter, BatchNorm, in_channels=self.in_channels)
